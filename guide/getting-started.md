...
请先安装 Go 1.25 或更高版本。建议使用 Go 官方仍在维护的最新补丁版本。
...
:::tip 使用正式 module path
准备提交到代码仓库时，建议显式指定 module path：`maltose new hello-maltose --module github.com/acme/hello-maltose`。CLI 会同时更新 `go.mod`、项目 import，并准备好依赖。
:::
